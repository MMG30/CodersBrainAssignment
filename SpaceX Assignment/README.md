Started with creating the design of the webpage.
...
Filtering functionality is prefectly done but filtered data from the API_ENDPOINT were not correct.
Webpage is also mobile responsive.
Thank you .

NOTE!!!-->The data given using API_ENDPOINT were not correct so filtering functionality may act abonormally with that of filter conditions. The problem was not with the functionality but it was with the DATA. Thank you :).
